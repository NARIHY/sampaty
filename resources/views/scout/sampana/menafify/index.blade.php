...
@section('title', 'Sampana Menafify')
@php 
                    ...
                    <div class="row">
                        ...
                        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-item">
                                <img src="/storage/{{$menafifies->image}}" width="100%" height="auto" preserveAspectRatio="xMidYMid slice" focusable="false" alt="">
                                <div class="container">
                            ...
                            <div class="carousel-item">
                                <img src="/storage/{{$menafifies->image_2}}" width="100%" height="auto" preserveAspectRatio="xMidYMid slice" focusable="false" alt="">
                                <div class="container">
                            ...
                            <div class="carousel-item active">
                                <img src="/storage/{{$menafifies->image_3}}" width="100%" height="auto" preserveAspectRatio="xMidYMid slice" focusable="false" alt="">
                                <div class="container">
